...
public:
    ...
    bool init(const std::string& target_ip, int target_port, const std::string& id, double z_height) 
    {
        vehicle_id = id;
        fixed_z = z_height;
